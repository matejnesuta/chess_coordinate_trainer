...
class App(tk.Tk): 
    ...
    def chessboard(self):     
        A1=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("A1"))
        A2=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("A2"))
        A3=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("A3"))
        A4=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("A4"))
        A5=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("A5"))
        A6=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("A6"))
        A7=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("A7"))
        A8=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("A8"))
        B1=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("B1"))
        ...
        C1=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("C1"))
        ...
        D1=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("D1"))
        ...
        E1=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("E1"))
        ...
        F1=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("F1"))
        ...
        G1=tk.Button(image=self.img,compound=tk.LEFT,bg="black",activebackground="grey",height=94,width=94,command=lambda:self.callback("G1"))
        ...
        H1=tk.Button(image=self.img,compound=tk.LEFT,bg="white",activebackground="grey",height=94,width=94,command=lambda:self.callback("H1"))
    ...
    def game(self): 
        ...
        while time:
            ...
            self.souradnice.set(coordinates[index])
            if tmp == coordinates[index]:
                score=score+1
                pokus=pokus+1
            else: 
                pokus=pokus+1   
